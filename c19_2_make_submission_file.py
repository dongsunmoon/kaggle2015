...
for l in lines:
    a = []
    a.append(l[0])
    a.append(int(round(float(l[1]))))
    a.append(int(round(float(l[2]))))
    lines2.append(a)
...
for l in lines:
    l[1] = max(l[1], 599.0)
    l[2] = max(l[2], 599.0)
    str_s = l[0] + '_Diastole'+(',0'*l[1]) + (',1.0'*(600-l[1]))
    str_d = l[0] + '_Systole' +(',0'*l[2]) + (',1.0'*(600-l[2]))
    list1[int(l[0])-501] = str_s;
    list2[int(l[0])-501] = str_d;

for i in range(200):
    if list1[i] == i:
        list1[i] = str(i+501) + '_Diastole'+(',0'* 50) + (',1.0'*(550))
    if list2[i] == i:
        list2[i] = str(i+501) + '_Systole'+(',0'*150) + (',1.0'*(450))
...
for i in range(200):
    out_file.write(list1[i]+'\n')
    out_file.write(list2[i]+'\n')
