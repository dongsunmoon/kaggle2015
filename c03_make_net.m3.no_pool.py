...
def FCN(images_lmdb, labels_lmdb, batch_size, include_acc=False):
    ...
    n.conv2, n.relu2 = conv_relu(n.relu1, ks=5, nout=100, stride=1, bias_value=0.1)
    n.conv3, n.relu3 = conv_relu(n.relu2, ks=3, nout=100, stride=1, bias_value=0.1)
    n.conv4, n.relu4 = conv_relu(n.relu3, ks=3, nout=100, stride=1, bias_value=0.1)
    n.drop = L.Dropout(n.relu4, dropout_ratio=0.5, in_place=True)
    n.score = L.Crop(n.drop,n.data)
