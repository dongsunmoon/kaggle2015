...
def FCN(images_lmdb, labels_lmdb, batch_size, include_acc=False):
    ...
    n.conv1, n.relu1 = conv_relu(n.data, ks=5, nout=100, stride=1, pad=50, bias_value=0.1)
    n.pool1 = max_pool(n.relu1, ks=2, stride=2)
    n.conv2, n.relu2 = conv_relu(n.pool1, ks=5, nout=200, stride=1, bias_value=0.1)
    n.pool2 = max_pool(n.relu2, ks=2, stride=2)
    n.conv3, n.relu3 = conv_relu(n.pool2, ks=5, nout=200, stride=2, bias_value=0.1)
    n.conv4, n.relu4 = conv_relu(n.relu3, ks=5, nout=200, stride=2, bias_value=0.1)
    n.conv5, n.relu5 = conv_relu(n.relu4, ks=5, nout=200, stride=1, bias_value=0.1)
    n.conv6, n.relu6 = conv_relu(n.relu5, ks=5, nout=200, stride=1, bias_value=0.1)
    n.conv7, n.relu7 = conv_relu(n.relu6, ks=5, nout=200, stride=1, bias_value=0.1)
    n.conv8, n.relu8 = conv_relu(n.relu7, ks=5, nout=200, stride=1, bias_value=0.1)
    n.drop = L.Dropout(n.relu8, dropout_ratio=0.1, in_place=True)
